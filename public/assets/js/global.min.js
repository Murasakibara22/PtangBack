...
function dezSettings({typography, version, layout, navheaderBg, headerBg, sidebarStyle, sidebarBg, sidebarPosition, headerPosition, containerLayout, direction, primary, navTextColor , navigationBarImg}) {
	...
	this.navTextColor = navTextColor || "color_1";
    this.navigationBarImg = navigationBarImg || null;
...
dezSettings.prototype.manageNavTextColor = function() {
	switch(this.navTextColor) {
        case "color_1": 
            body.attr("data-sibebartext", "color_1");
			 break;
        case "color_2": 
            body.attr("data-sibebartext", "color_2");
            break;
		case "color_3": 
            body.attr("data-sibebartext", "color_3");
            break;
		case "color_4": 
            body.attr("data-sibebartext", "color_4");
            break;
		case "color_5": 
            body.attr("data-sibebartext", "color_5");
            break;
		case "color_6": 
            body.attr("data-sibebartext", "color_6");
            break;	
		case "color_7": 
            body.attr("data-sibebartext", "color_7");
            break;
		case "color_8": 
            body.attr("data-sibebartext", "color_8");
            break;
		case "color_9": 
            body.attr("data-sibebartext", "color_9");
            break;
		case "color_10": 
            body.attr("data-sibebartext", "color_10");
            break;
		case "color_11": 
            body.attr("data-sibebartext", "color_11");
            break;
		case "color_12": 
            body.attr("data-sibebartext", "color_12");
            break;
		case "color_13": 
            body.attr("data-sibebartext", "color_13");
            break;
		case "color_14": 
            body.attr("data-sibebartext", "color_14");
            break;
		case "color_15": 
            body.attr("data-sibebartext", "color_15");
            break;	
...
dezSettings.prototype.manageNavigationBarImg = function() {
	if(this.navigationBarImg != null){
        jQuery('.nav-header').addClass('light-logo dez-bg').css('background','url('+this.navigationBarImg+')');
        jQuery('.deznav').addClass('dez-bg').css('background','url('+this.navigationBarImg+')');
    }
