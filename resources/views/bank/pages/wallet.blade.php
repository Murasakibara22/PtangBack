...
<div class="content-body">
    <div class="container-fluid">
        ...
        <div class="form-head mb-4">
            <h2 class="text-black font-w600 mb-0">{{ __('app.my_wallet') }}</h2>
        </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card stacked-2">
                            <div class="card-header flex-wrap border-0 pb-0 align-items-end">
                                ...
                                {{-- Date validité dynamique --}}
                                <div class="me-3 mb-3">
                                    <p class="fs-14 mb-1">{{ __('app.validation') }}</p>
                                    <span class="text-black">{{ auth()->user()->date_validite ?? '08/31' }}</span>
                                </div>

                                {{-- Nom titulaire dynamique --}}
                                <div class="me-3 mb-3">
                                ...
                                {{-- Numéro carte masqué dynamique --}}
                                <span class="fs-20 text-black font-w500 me-3 mb-3">
                                    **** **** **** {{ substr(auth()->user()->numero_carte ?? '789', -3) }}
                                </span>
                            ...
                            <div class="card-body">
                                <div class="progress mb-4" style="height:18px;">
                                    <div class="progress-bar bg-inverse progress-animated"
                                         style="width: {{ auth()->user()->progression ?? 40 }}%; height:18px;"
                                         role="progressbar">
                                        <span class="sr-only">{{ __('app.progress_complete') }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-xl-3 mb-3 col-xxl-6 col-sm-6">
                                        <div class="media align-items-center bgl-secondary rounded p-2">
                                            ...
                                            <div class="media-body">
                                                <h4 class="fs-15 text-black font-w600 mb-0">{{ __('app.bills') }}</h4>
                                    ...
                                    <div class="col-xl-3 mb-3 col-xxl-6 col-sm-6">
                                        <div class="media bgl-success rounded p-2 align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h4 class="fs-15 text-black font-w600 mb-0">{{ __('app.investment') }}</h4>
                                    ...
                                    <div class="col-xl-3 mb-3 col-xxl-6 col-sm-6">
                                        <div class="media bgl-info rounded p-2 align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h4 class="fs-15 text-black font-w600 mb-0">{{ __('app.restaurant') }}</h4>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header d-block d-sm-flex border-0">
                                <div>
                                    <h4 class="fs-20 text-black">{{ __('app.payment_history') }}</h4>
                                    <p class="mb-0 fs-13">{{ __('app.payments') }}</p>
                                </div>
                            ...
                            <div class="card-body payment-bx tab-content p-0">
                                <div class="tab-pane active show fade" id="monthly" role="tabpanel">
                                    <div id="accordion-one" class="accordion accordion-primary">
                                            ...
                                            <div class="d-flex flex-wrap align-items-center accordion__header collapsed rounded"
                                                ...
                                                <div class="mb-lg-0 mb-3 d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="fs-14">
                                                            {{ $tx->type_commerce ?? __('app.online_shop') }}
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <span class="mb-lg-0 mb-3 text-black px-2">
                                                    {{ \Carbon\Carbon::parse($tx->created_at)->locale('de')->isoFormat('D. MMMM YYYY') }}<br>
                                                    {{ \Carbon\Carbon::parse($tx->created_at)->format('H:i') }} Uhr
                                                </span>

                                                {{-- Montant + signe --}}
                                                <span class="mb-lg-0 mb-3 text-black font-w600 px-2">
                                                    {{ $tx->type === 'credit' ? '+' : '-' }}{{ number_format($tx->montant, 2, ',', '.') }} €
                                                </span>

                                                {{-- Méthode de paiement --}}
                                                <span class="mb-lg-0 mb-3 text-black font-w600 px-2">
                                                    {{ $tx->methode_paiement ?? 'MasterCard' }}
                                                </span>

                                                {{-- Badge statut en allemand --}}
                                                @php
                                                    $badgeClass = match($tx->statut ?? 'completed') {
                                                        'completed' => 'btn-outline-success',
                                                        'canceled'  => 'btn-outline-dark',
                                                        'pending'   => 'btn-outline-warning',
                                                        default     => 'btn-outline-secondary',
                                                    };
                                                    $statusLabel = match($tx->statut ?? 'completed') {
                                                ...
                                                @endphp
                                                <a class="mb-lg-0 mb-3 btn {{ $badgeClass }} btn-md btn-rounded mx-2"
                                        ...
                                        @empty
                                        <div class="p-4 text-center text-muted fs-14">
                                            {{ __('app.no_transactions') }}
                                        </div>
                                        @endforelse
                        ...
                        <div class="card bg-primary" style="cursor:pointer;"
                            ...
                            <div class="card-body p-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="fs-20 text-white">{{ __('app.transfer') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card bg-success">
                            <div class="card-body p-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="fs-20 text-white">{{ __('app.pay_bills') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
