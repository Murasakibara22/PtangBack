                            ...
                            <div class="card stacked-2">
                                <div class="card-header flex-wrap border-0 pb-0 align-items-end">
                                    <div class="d-flex align-items-center mb-3 me-3">
                                        <svg class="me-3" width="68" height="68" viewBox="0 0 68 68" fill="none"
                                        ...
                                        <div class="me-auto">
                                            ...
                                            <span class="text-num text-black font-w600">$673,412.66</span>
                                        </div>
                                    </div>
                                    <div class="me-3 mb-3">
                                    ...
                                    <div class="me-3 mb-3">
                                        ...
                                        <span class="text-black">Franklin Jr.</span>
                                    </div>
                                    <span class="fs-20 text-black font-w500 me-3 mb-3">**** **** **** 1234</span>
                                    <div class="dropdown mb-auto">
                                        <div class="btn-link" role="button" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                ...
                                <div class="card-body">
                                    <div class="progress mb-4" style="height:18px;">
                                        <div class="progress-bar bg-inverse progress-animated"
                                            style="width: 40%; height:18px;" role="progressbar">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-xl-3 mb-3 col-xxl-6 col-sm-6">
                                            <div class="media align-items-center bgl-secondary rounded p-2">
                                                <div class="d-inline-block me-3 position-relative donut-chart-sale2">
                                                    <span class="donut2"
                                                        data-peity='{ "fill": ["rgb(172, 57, 212)", "rgba(255, 255, 255, 0)"],   "innerRadius": 23, "radius": 10}'>3/8</span>
                                        ...
                                        <div class="col-xl-3 mb-3 col-xxl-6 col-sm-6">
                                            <div class="media bgl-success rounded p-2 align-items-center">
                                                <div class="d-inline-block me-3 position-relative donut-chart-sale2">
                                                    <span class="donut2"
                                                        data-peity='{ "fill": ["rgb(43, 193, 85)", "rgba(255, 255, 255, 0)"],   "innerRadius": 23, "radius": 10}'>8/10</span>
                                        ...
                                        <div class="col-xl-3 mb-3 col-xxl-6 col-sm-6">
                                            <div class="media bgl-info rounded p-2 align-items-center">
                                                <div class="d-inline-block me-3 position-relative donut-chart-sale2">
                                                    <span class="donut2"
                                                        data-peity='{ "fill": ["rgb(70, 30, 231)", "rgba(255, 255, 255, 0)"],   "innerRadius": 23, "radius": 10}'>4/10</span>
                                        ...
                                        <div class="col-xl-3 mb-3 col-xxl-6 col-sm-6">
                                            <a class="btn btn-outline-primary rounded d-block btn-lg" data-bs-toggle="modal"
                                                data-bs-target="#newspends">+New Spends</a>
                                ...
                                <div class="card-body payment-bx tab-content p-0">
                                        ...
                                        <div id="accordion-one" class="accordion accordion-primary">
                                            <div class="accordion__item border-bottom mb-0">
                                                <div class="d-flex flex-wrap align-items-center accordion__header collapsed rounded"
                                                    data-bs-toggle="collapse" data-bs-target="#default_collapseOne1">
                                                    <div class="mb-lg-0 mb-3 d-flex align-items-center">
                                                        <div class="profile-image me-4">
                                                            <img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/10.png"
                                                        ...
                                                        <div>
                                                            <h6 class="fs-16 font-w700 mb-0"><a class="text-black"
                                                                    href="javascript:void(0)">XYZ Store ID</a></h6>
                                                            <span class="fs-14">Online Shop</span>
                                                        </div>
                                                    </div>
                                                    <span class="mb-lg-0 mb-3 text-black px-2">June 1, 2020 <br>08:22
                                                        AM</span>
                                                    <span class="mb-lg-0 mb-3 text-black font-w600 px-2">+$5,553</span>
                                                    <span class="mb-lg-0 mb-3 text-black font-w600 px-2">MasterCard
                                                        404</span>
                                                    <a class="mb-lg-0 mb-3 btn btn-outline-success btn-md btn-rounded mx-2"
                                                        href="javascript:void(0)">Completed</a>
                                                    <span class="accordion__header--indicator"></span>
                                                </div>
                                                <div id="default_collapseOne1" class="collapse accordion__body"
                                                    data-bs-parent="#accordion-one">
                                                    <div
                                                        class="d-flex flex-wrap align-items-center accordion__body--text p-0">
                                                        <div class="me-3 mb-3">
                                                        ...
                                                        <div class="d-flex p-3 rounded bgl-dark align-items-center mb-3">
                                                            ...
                                                            <p class="mb-0 fs-14">Lorem ipsum dolor sit<br> amet,
                                                                consectetur </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="accordion__item border-bottom mb-0">
                                                <div class="d-flex flex-wrap align-items-center accordion__header collapsed rounded"
                                                    data-bs-toggle="collapse" data-bs-target="#default_collapseOne2">
                                                    <div class="mb-lg-0 mb-3 d-flex align-items-center">
                                                        <div class="profile-image me-4">
                                                            <img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/11.png"
                                                                alt="" width="63" class="rounded-circle">
                                                        ...
                                                        <div>
                                                            <h6 class="fs-16 font-w700 mb-0"><a class="text-black"
                                                                    href="javascript:void(0)">Andrew Lee</a></h6>
                                                        </div>
                                                    </div>
                                                    <span class="mb-lg-0 mb-3 text-black px-2">June 3, 2020 <br>04:29
                                                        AM</span>
                                                    <span class="mb-lg-0 mb-3 text-black font-w600 px-2">+$2,351</span>
                                                    <span class="mb-lg-0 mb-3 text-black font-w600 px-2">MasterCard
                                                        404</span>
                                                    <a class="mb-lg-0 mb-3 btn btn-outline-dark btn-md btn-rounded mx-2"
                                                        href="javascript:void(0)">Canceled</a>
                                                    <span class="accordion__header--indicator"></span>
                                                </div>
                                                <div id="default_collapseOne2" class="collapse accordion__body"
                                                    data-bs-parent="#accordion-one">
                                                    <div
                                                        class="d-flex flex-wrap align-items-center accordion__body--text p-0">
                                                        <div class="me-3 mb-3">
                                            ...
                                            <div class="accordion__item border-bottom mb-0">
                                                <div class="d-flex flex-wrap align-items-center accordion__header collapsed rounded"
                                                    data-bs-toggle="collapse" data-bs-target="#default_collapseOne3">
                                                    <div class="mb-lg-0 mb-3 d-flex align-items-center">
                                                        <div class="profile-image me-4">
                                                            <img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/12.png"
                                                                alt="" width="63" class="rounded-circle">
                                                            <span class="bg-success">
                                                                <svg width="16" height="16" viewBox="0 0 16 16"
                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <div>
                                                            <h6 class="fs-16 font-w700 mb-0"><a class="text-black"
                                                                    href="javascript:void(0)">Olivia Brownlee</a></h6>
                                                        </div>
                                                    </div>
                                                    <span class="mb-lg-0 mb-3 text-black px-2">June 4, 2020 <br>02:37
                                                        AM</span>
                                                ...
                                                <div id="default_collapseOne3" class="collapse accordion__body"
                                                    data-bs-parent="#accordion-one">
                                                    <div
                                                        class="d-flex flex-wrap align-items-center accordion__body--text p-0">
                                                        <div class="me-3 mb-3">
                                            ...
                                            <div class="accordion__item border-bottom mb-0">
                                                <div class="d-flex flex-wrap align-items-center accordion__header collapsed rounded"
                                                    data-bs-toggle="collapse" data-bs-target="#default_collapseOne4">
                                                    <div class="mb-lg-0 mb-3 d-flex align-items-center">
                                                        <div class="profile-image me-4">
                                                            <img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/14.png"
                                                                alt="" width="63" class="rounded-circle">
                                                            <span class="bg-success">
                                                                <svg width="16" height="16" viewBox="0 0 16 16"
                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <div>
                                                            <h6 class="fs-16 font-w700 mb-0"><a class="text-black"
                                                                    href="javascript:void(0)">Popo Store</a></h6>
                                                            <span class="fs-14">Online Shop</span>
                                                        </div>
                                                    </div>
                                                    <span class="mb-lg-0 mb-3 text-black px-2">June 5, 2020 <br>08:22
                                                        AM</span>
                                                    <span class="mb-lg-0 mb-3 text-black font-w600 px-2">+$5,553</span>
                                                    <span class="mb-lg-0 mb-3 text-black font-w600 px-2">MasterCard
                                                        404</span>
                                                    <a class="mb-lg-0 mb-3 btn btn-outline-warning btn-md btn-rounded mx-2"
                                                        href="javascript:void(0)">Pending</a>
                                                    <span class="accordion__header--indicator"></span>
                                                </div>
                                                <div id="default_collapseOne4" class="collapse accordion__body"
                                                    data-bs-parent="#accordion-one">
                                                    <div
                                                        class="d-flex flex-wrap align-items-center accordion__body--text p-0">
                                                        <div class="me-3 mb-3">
                                            ...
                                            <div class="accordion__item border-bottom mb-0">
                                                <div class="d-flex flex-wrap align-items-center accordion__header collapsed rounded"
                                                    data-bs-toggle="collapse" data-bs-target="#default_collapseOne5">
                                                    <div class="mb-lg-0 mb-3 d-flex align-items-center">
                                                        <div class="profile-image me-4">
                                                            <img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/13.png"
                                                                alt="" width="63" class="rounded-circle">
                                                            <span class="bg-danger">
                                                                <svg width="16" height="16" viewBox="0 0 16 16"
                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <div>
                                                            <h6 class="fs-16 font-w700 mb-0"><a class="text-black"
                                                                    href="javascript:void(0)">Peter Parkur</a></h6>
                                                        </div>
                                                    </div>
                                                    <span class="mb-lg-0 mb-3 text-black px-2">June 10, 2020 <br>08:22
                                                        AM</span>
                                                    <span class="mb-lg-0 mb-3 text-black font-w600 px-2">+$5,553</span>
                                                    <span class="mb-lg-0 mb-3 text-black font-w600 px-2">MasterCard
                                                        404</span>
                                                ...
                                                <div id="default_collapseOne5" class="collapse accordion__body"
                                                    data-bs-parent="#accordion-one">
                                                    <div
                                                        class="d-flex flex-wrap align-items-center accordion__body--text p-0">
                                                        <div class="me-3 mb-3">
                                    ...
                                    <div class="tab-pane fade" id="Weekly" role="tabpanel">
                                        <div id="accordion-two" class="accordion accordion-primary">
                                            <div class="accordion__item border-bottom mb-0">
                                                <div class="d-flex flex-wrap align-items-center accordion__header collapsed rounded"
                                                    data-bs-toggle="collapse" data-bs-target="#default_collapseOne1d">
                                                    <div class="mb-lg-0 mb-3 d-flex align-items-center">
                                                        <div class="profile-image me-4">
                                                            <img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/10.png"
                                                                alt="" width="63" class="rounded-circle">
                                                ...
                                                <div id="default_collapseOne1d" class="collapse accordion__body"
                                                    data-bs-parent="#accordion-one">
                                                    <div
                                                        class="d-flex flex-wrap align-items-center accordion__body--text p-0">
                                                        <div class="me-3 mb-3">
                                            ...
                                            <div class="accordion__item border-bottom mb-0">
                                                <div class="d-flex flex-wrap align-items-center accordion__header collapsed rounded"
                                                    data-bs-toggle="collapse" data-bs-target="#default_collapseOne222">
                                                    <div class="mb-lg-0 mb-3 d-flex align-items-center">
                                                        <div class="profile-image me-4">
                                                            <img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/11.png"
                                                                alt="" width="63" class="rounded-circle">
                                                ...
                                                <div id="default_collapseOne222" class="collapse accordion__body"
                                                    data-bs-parent="#accordion-one">
                                                    <div
                                                        class="d-flex flex-wrap align-items-center accordion__body--text p-0">
                                                        <div class="me-3 mb-3">
                                            ...
                                            <div class="accordion__item border-bottom mb-0">
                                                <div class="d-flex flex-wrap align-items-center accordion__header collapsed rounded"
                                                    data-bs-toggle="collapse" data-bs-target="#default_collapseOne321">
                                                    <div class="mb-lg-0 mb-3 d-flex align-items-center">
                                                        <div class="profile-image me-4">
                                                            <img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/12.png"
                                                                alt="" width="63" class="rounded-circle">
                                                ...
                                                <div id="default_collapseOne321" class="collapse accordion__body"
                                                    data-bs-parent="#accordion-one">
                                                    <div
                                                        class="d-flex flex-wrap align-items-center accordion__body--text p-0">
                                                        <div class="me-3 mb-3">
                                    ...
                                    <div class="tab-pane fade" id="Today" role="tabpanel">
                                        <div id="accordion-three" class="accordion accordion-primary">
                                            <div class="accordion__item border-bottom mb-0">
                                                <div class="d-flex flex-wrap align-items-center accordion__header collapsed rounded"
                                                    data-bs-toggle="collapse" data-bs-target="#default_collapseOne51">
                                                    <div class="mb-lg-0 mb-3 d-flex align-items-center">
                                                        <div class="profile-image me-4">
                                                            <img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/13.png"
                                                                alt="" width="63" class="rounded-circle">
                                                ...
                                                <div id="default_collapseOne51" class="collapse accordion__body"
                                                    data-bs-parent="#accordion-one">
                                                    <div
                                                        class="d-flex flex-wrap align-items-center accordion__body--text p-0">
                                                        <div class="me-3 mb-3">
                            ...
                            <div class="card bg-success">
                                <div class="card-body p-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="fs-20 text-white">Send Invoices </span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex pb-3 border-bottom mb-3 align-items-center">
                                        <img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/15.png"
                                            alt="" class="rounded-circle me-3" width="50">
                                        <div class="me-auto">
                                            <h6 class="fs-16 font-w600 mb-0"><a
                                                    href="https://mophy.dexignzone.com/codeigniter/demo/admin/invoices"
                                                    class="text-black">FSoziety</a></h6>
                                    ...
                                    <div class="d-flex align-items-center pb-3 border-bottom mb-3">
                                        <img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/17.png"
                                            alt="" class="rounded-circle me-3" width="50">
                                        <div class="me-auto">
                                            <h6 class="fs-16 font-w600 mb-0"><a
                                                    href="https://mophy.dexignzone.com/codeigniter/demo/admin/invoices"
                                                    class="text-black">David Ignis</a></h6>
                                            <span class="fs-12">7h ago</span>
                                        </div>
                                        <span class="fs-16 text-black font-w600">$672</span>
                                    </div>
                                    <div class="d-flex align-items-center pb-3 border-bottom mb-3">
                                        <img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/18.png"
                                            alt="" class="rounded-circle me-3" width="50">
                                        <div class="me-auto">
                                            <h6 class="fs-16 font-w600 mb-0"><a
                                                    href="https://mophy.dexignzone.com/codeigniter/demo/admin/invoices"
                                                    class="text-black">Olivia Johan..</a></h6>
                                            <span class="fs-12">4h ago</span>
                                        </div>
                                        <span class="fs-16 text-black font-w600">$769</span>
                                    </div>
                                    <div class="d-flex align-items-center pb-3 border-bottom mb-3">
                                        <img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/16.png"
                                            alt="" class="rounded-circle me-3" width="50">
                                        <div class="me-auto">
                                            <h6 class="fs-16 font-w600 mb-0"><a
                                                    href="https://mophy.dexignzone.com/codeigniter/demo/admin/invoices"
                                                    class="text-black">Stevan Store</a></h6>
                                            <span class="fs-12">4h ago</span>
                                        </div>
                                        <span class="fs-16 text-black font-w600">$562</span>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/17.png"
                                            alt="" class="rounded-circle me-3" width="50">
                                        <div class="me-auto">
                                            <h6 class="fs-16 font-w600 mb-0"><a
                                                    href="https://mophy.dexignzone.com/codeigniter/demo/admin/invoices"
                                                    class="text-black">Kidz Zoo</a></h6>
                                            <span class="fs-12">4h ago</span>
                                        </div>
                                        <span class="fs-16 text-black font-w600">$776</span>
                                    </div>
                                </div>
                            </div>
                        </div>
