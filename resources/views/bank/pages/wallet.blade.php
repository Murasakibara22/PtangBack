							...
							<div class="card-header flex-wrap border-0 pb-0 align-items-end">
								<div class="d-flex align-items-center mb-3 me-3">
									...
									<div class="me-auto">
										...
										<span class="text-num text-black font-w600">780 000 €</span>
									</div>
								</div>
								<div class="me-3 mb-3">
							...
							<div class="card-body payment-bx tab-content p-0">
								<div class="tab-pane active show fade" id="monthly" role="tabpanel">
									 <div id="accordion-one" class="accordion accordion-primary">
											...
											<div class="d-flex flex-wrap align-items-center accordion__header collapsed rounded" data-bs-toggle="collapse" data-bs-target="#default_collapseOne1">
												<div class="mb-lg-0 mb-3 d-flex align-items-center">
													<div class="profile-image me-4">
														<img src="images/10.png" alt="" width="63" class="rounded-circle">
											...
											<div id="default_collapseOne1" class="collapse accordion__body" data-bs-parent="#accordion-one">
												<div class="d-flex flex-wrap align-items-center accordion__body--text p-0">
													...
													<div class="me-3 mb-3">
														...
														<span class="text-black font-w500">18 janv. 2023</span>
													</div>
													<div class="me-3 mb-3">
										...
										<div class="accordion__item border-bottom mb-0">
											...
											<div id="default_collapseOne2" class="collapse accordion__body" data-bs-parent="#accordion-one">
												<div class="d-flex flex-wrap align-items-center accordion__body--text p-0">
													...
													<div class="me-3 mb-3">
														<p class="fs-12 mb-2">Invoice Date</p>
														<span class="text-black font-w500">Jan 9, 2023</span>
													</div>
													<div class="me-3 mb-3">
														<p class="fs-12 mb-2">Due Date</p>
														<span class="text-black font-w500">Jan 5, 2023</span>
													</div>
													<div class="me-3 mb-3">
														<p class="fs-12 mb-2">Date Paid</p>
														<span class="text-black font-w500">Jan 4, 2023</span>
													</div>
													<div class="d-flex p-3 rounded bgl-dark align-items-center mb-3">
														<svg class="me-3" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
															<path d="M12 1C9.82441 1 7.69767 1.64514 5.88873 2.85384C4.07979 4.06253 2.66989 5.7805 1.83733 7.79049C1.00477 9.80047 0.786929 12.0122 1.21137 14.146C1.6358 16.2798 2.68345 18.2398 4.22183 19.7782C5.76021 21.3166 7.72022 22.3642 9.85401 22.7887C11.9878 23.2131 14.1995 22.9953 16.2095 22.1627C18.2195 21.3301 19.9375 19.9202 21.1462 18.1113C22.3549 16.3023 23 14.1756 23 12C22.9966 9.08368 21.8365 6.28778 19.7744 4.22563C17.7122 2.16347 14.9163 1.00344 12 1ZM12 21C10.22 21 8.47992 20.4722 6.99987 19.4832C5.51983 18.4943 4.36628 17.0887 3.68509 15.4442C3.0039 13.7996 2.82567 11.99 3.17294 10.2442C3.5202 8.49836 4.37737 6.89471 5.63604 5.63604C6.89472 4.37737 8.49836 3.5202 10.2442 3.17293C11.99 2.82567 13.7996 3.0039 15.4442 3.68509C17.0887 4.36627 18.4943 5.51983 19.4832 6.99987C20.4722 8.47991 21 10.22 21 12C20.9971 14.3861 20.0479 16.6736 18.3608 18.3608C16.6736 20.048 14.3861 20.9971 12 21Z" fill="#A4A4A4"></path>
										...
										<div class="accordion__item border-bottom mb-0">
											<div class="d-flex flex-wrap align-items-center accordion__header collapsed rounded" data-bs-toggle="collapse" data-bs-target="#default_collapseOne3">
												<div class="mb-lg-0 mb-3 d-flex align-items-center">
													<div class="profile-image me-4">
														<img src="images/12.png" alt="" width="63" class="rounded-circle">
														<span class="bg-success">
															<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<div class="accordion__item border-bottom mb-0">
											<div class="d-flex flex-wrap align-items-center accordion__header collapsed rounded" data-bs-toggle="collapse" data-bs-target="#default_collapseOne4">
												<div class="mb-lg-0 mb-3 d-flex align-items-center">
													<div class="profile-image me-4">
														<img src="images/14.png" alt="" width="63" class="rounded-circle">
														<span class="bg-success">
															<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
												...
												<span class="mb-lg-0 mb-3 text-black px-2">June 5, 2020 <br>08:22 AM</span>
												<span class="mb-lg-0 mb-3 text-black font-w600 px-2">+5,553 €</span>
												<span class="mb-lg-0 mb-3 text-black font-w600 px-2">MasterCard 404</span>
												<a class="mb-lg-0 mb-3 btn btn-outline-warning btn-md btn-rounded mx-2" href="javascript:void(0)">Pending</a>
												<span class="accordion__header--indicator"></span>
											</div>
											<div id="default_collapseOne4" class="collapse accordion__body" data-bs-parent="#accordion-one">
												<div class="d-flex flex-wrap align-items-center accordion__body--text p-0">
													<div class="me-3 mb-3">
														<p class="fs-12 mb-2">ID Payment</p>
														<span class="text-black font-w500">#00123521</span>
										...
										<div class="accordion__item border-bottom mb-0">
											<div class="d-flex flex-wrap align-items-center accordion__header collapsed rounded" data-bs-toggle="collapse" data-bs-target="#default_collapseOne5">
												<div class="mb-lg-0 mb-3 d-flex align-items-center">
													<div class="profile-image me-4">
														<img src="images/13.png" alt="" width="63" class="rounded-circle">
														<span class="bg-danger">
															<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<div id="default_collapseOne5" class="collapse accordion__body" data-bs-parent="#accordion-one">
												<div class="d-flex flex-wrap align-items-center accordion__body--text p-0">
													<div class="me-3 mb-3">
														<p class="fs-12 mb-2">ID Payment</p>
														<span class="text-black font-w500">#00123521</span>
								...
								<div class="tab-pane fade" id="Weekly" role="tabpanel">
									 <div id="accordion-two" class="accordion accordion-primary">
										<div class="accordion__item border-bottom mb-0">
											<div class="d-flex flex-wrap align-items-center accordion__header collapsed rounded" data-bs-toggle="collapse" data-bs-target="#default_collapseOne1d">
												<div class="mb-lg-0 mb-3 d-flex align-items-center">
													<div class="profile-image me-4">
														<img src="images/10.png" alt="" width="63" class="rounded-circle">
														<span class="bg-success">
											...
											<div id="default_collapseOne1d" class="collapse accordion__body" data-bs-parent="#accordion-one">
												<div class="d-flex flex-wrap align-items-center accordion__body--text p-0">
													<div class="me-3 mb-3">
														<p class="fs-12 mb-2">ID Payment</p>
														<span class="text-black font-w500">#00123521</span>
										...
										<div class="accordion__item border-bottom mb-0">
											<div class="d-flex flex-wrap align-items-center accordion__header collapsed rounded" data-bs-toggle="collapse" data-bs-target="#default_collapseOne222">
												<div class="mb-lg-0 mb-3 d-flex align-items-center">
													<div class="profile-image me-4">
														<img src="images/11.png" alt="" width="63" class="rounded-circle">
														<span class="bg-danger">
											...
											<div id="default_collapseOne222" class="collapse accordion__body" data-bs-parent="#accordion-one">
												<div class="d-flex flex-wrap align-items-center accordion__body--text p-0">
													<div class="me-3 mb-3">
														<p class="fs-12 mb-2">ID Payment</p>
														<span class="text-black font-w500">#00123521</span>
										...
										<div class="accordion__item border-bottom mb-0">
											<div class="d-flex flex-wrap align-items-center accordion__header collapsed rounded" data-bs-toggle="collapse" data-bs-target="#default_collapseOne321">
												<div class="mb-lg-0 mb-3 d-flex align-items-center">
													<div class="profile-image me-4">
														<img src="images/12.png" alt="" width="63" class="rounded-circle">
														<span class="bg-success">
											...
											<div id="default_collapseOne321" class="collapse accordion__body" data-bs-parent="#accordion-one">
												<div class="d-flex flex-wrap align-items-center accordion__body--text p-0">
													<div class="me-3 mb-3">
														<p class="fs-12 mb-2">ID Payment</p>
														<span class="text-black font-w500">#00123521</span>
								...
								<div class="tab-pane fade" id="Today" role="tabpanel">
									 <div id="accordion-three" class="accordion accordion-primary">
										<div class="accordion__item border-bottom mb-0">
											<div class="d-flex flex-wrap align-items-center accordion__header collapsed rounded" data-bs-toggle="collapse" data-bs-target="#default_collapseOne51">
												<div class="mb-lg-0 mb-3 d-flex align-items-center">
													<div class="profile-image me-4">
														<img src="images/13.png" alt="" width="63" class="rounded-circle">
														<span class="bg-danger">
											...
											<div id="default_collapseOne51" class="collapse accordion__body" data-bs-parent="#accordion-one">
												<div class="d-flex flex-wrap align-items-center accordion__body--text p-0">
													<div class="me-3 mb-3">
														<p class="fs-12 mb-2">ID Payment</p>
														<span class="text-black font-w500">#00123521</span>
					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header pb-0 border-0">
								<div>
									<h4 class="fs-20 text-black mb-0">Factures Payés</h4>
									<span class="fs-12">Lorem ipsum dolor sit amet, consectetur</span>
								</div>
							</div>
							<div class="card-body">
								<div class="d-flex pb-3 border-bottom mb-3 align-items-center">
									<img src="images/15.png" alt="" class="rounded-circle me-3" width="50">
									<div class="me-auto">
										<h6 class="fs-16 font-w600 mb-0"><a href="https://mophy.dexignzone.com/codeigniter/demo/admin/invoices" class="text-black">FSoziety</a></h6>
								...
								<div class="d-flex align-items-center pb-3 border-bottom mb-3">
									<img src="images/17.png" alt="" class="rounded-circle me-3" width="50">
									<div class="me-auto">
										<h6 class="fs-16 font-w600 mb-0"><a href="https://mophy.dexignzone.com/codeigniter/demo/admin/invoices" class="text-black">David Ignis</a></h6>
										<span class="fs-12">7h ago</span>
									</div>
									<span class="fs-16 text-black font-w600">$672</span>
								</div>
								<div class="d-flex align-items-center pb-3 border-bottom mb-3">
									<img src="images/18.png" alt="" class="rounded-circle me-3" width="50">
									<div class="me-auto">
										<h6 class="fs-16 font-w600 mb-0"><a href="https://mophy.dexignzone.com/codeigniter/demo/admin/invoices" class="text-black">Olivia Johan..</a></h6>
										<span class="fs-12">4h ago</span>
									</div>
									<span class="fs-16 text-black font-w600">$769</span>
								</div>
								<div class="d-flex align-items-center pb-3 border-bottom mb-3">
									<img src="images/16.png" alt="" class="rounded-circle me-3" width="50">
									<div class="me-auto">
										<h6 class="fs-16 font-w600 mb-0"><a href="https://mophy.dexignzone.com/codeigniter/demo/admin/invoices" class="text-black">Stevan Store</a></h6>
										<span class="fs-12">4h ago</span>
									</div>
								...
								<div class="d-flex align-items-center">
									<img src="images/17.png" alt="" class="rounded-circle me-3" width="50">
									<div class="me-auto">
										<h6 class="fs-16 font-w600 mb-0"><a href="https://mophy.dexignzone.com/codeigniter/demo/admin/invoices" class="text-black">Kidz Zoo</a></h6>
										<span class="fs-12">4h ago</span>
									</div>
