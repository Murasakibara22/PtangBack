<div class="content-body">
	...
	<div class="container-fluid">
		<div class= "page-titles form-head d-flex flex-wrap justify-content-between align-items-center mb-4">
			<h2 class="text-black font-w600 mb-0 me-auto mb-2 pe-3">Transactions History</h2>
					...
					<table class="table display mb-4 dataTablesCard " id="example5">
						...
						<tbody>
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										<img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/11.png" alt="" class="rounded-circle me-3" width="50">
										<div>
											<h6 class="fs-16 font-w600 mb-0 text-nowrap"><a href="https://mophy.dexignzone.com/codeigniter/demo/admin/transactions_details" class="text-black">David Oconner</a></h6>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										<img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/17.png" alt="" class="rounded-circle me-3" width="50">
										<div>
											<h6 class="fs-16 font-w600 mb-0 text-nowrap"><a href="https://mophy.dexignzone.com/codeigniter/demo/admin/transactions_details" class="text-black">Julia Esteh</a></h6>
										</div>
									</div>
								</td>
								<td><span class="text-black fs-16 font-w600">$128.89</span></td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										<img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/25.png" alt="" class="rounded-circle me-3" width="50">
										<div>
											<h6 class="fs-16 font-w600 mb-0 text-nowrap"><a href="https://mophy.dexignzone.com/codeigniter/demo/admin/transactions_details" class="text-black">Clown Studio</a></h6>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										<img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/27.png" alt="" class="rounded-circle me-3" width="50">
										<div>
											<h6 class="fs-16 font-w600 mb-0 text-nowrap"><a href="https://mophy.dexignzone.com/codeigniter/demo/admin/transactions_details" class="text-black">Jeremy Tedy</a></h6>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										<img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/23.png" alt="" class="rounded-circle me-3" width="50">
										<div>
											<h6 class="fs-16 font-w600 mb-0 text-nowrap"><a href="https://mophy.dexignzone.com/codeigniter/demo/admin/transactions_details" class="text-black">Samuel Bro</a></h6>
										</div>
									</div>
								</td>
								<td><span class="text-black fs-16 font-w600">$128.89</span></td>
								...
								<td><span class="text-black">Bangladesh, <br>India</span></td>
								<td><a href="javascript:void(0)" class="btn btn-sm btn-danger light">Cancelled</a></td>
								<td>
									<div class="dropdown mb-auto">
										<div class="btn-link" role="button" data-bs-toggle="dropdown" aria-expanded="false">
											<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										<img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/28.png" alt="" class="rounded-circle me-3" width="50">
										<div>
											<h6 class="fs-16 font-w600 mb-0 text-nowrap"><a href="https://mophy.dexignzone.com/codeigniter/demo/admin/transactions_details" class="text-black">Yellow Caw</a></h6>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										<img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/29.png" alt="" class="rounded-circle me-3" width="50">
										<div>
											<h6 class="fs-16 font-w600 mb-0 text-nowrap"><a href="https://mophy.dexignzone.com/codeigniter/demo/admin/transactions_details" class="text-black">Cindy Seea</a></h6>
										</div>
									</div>
								</td>
								<td><span class="text-black fs-16 font-w600">$128.89</span></td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										<img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/22.png" alt="" class="rounded-circle me-3" width="50">
										<div>
											<h6 class="fs-16 font-w600 mb-0 text-nowrap"><a href="https://mophy.dexignzone.com/codeigniter/demo/admin/transactions_details" class="text-black">Nurkomariah</a></h6>
										</div>
									</div>
								</td>
								<td><span class="text-black fs-16 font-w600">$783.22</span></td>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										<img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/25.png" alt="" class="rounded-circle me-3" width="50">
										<div>
											<h6 class="fs-16 font-w600 mb-0 text-nowrap"><a href="https://mophy.dexignzone.com/codeigniter/demo/admin/transactions_details" class="text-black">XYZ Store ID</a></h6>
							...
							<tr>
								...
								<td>
									<div class="d-flex align-items-center">
										<img src="https://mophy.dexignzone.com/codeigniter/demo/public/assets/images/avatar/20.png" alt="" class="rounded-circle me-3" width="50">
										<div>
											<h6 class="fs-16 font-w600 mb-0 text-nowrap"><a href="https://mophy.dexignzone.com/codeigniter/demo/admin/transactions_details" class="text-black">Romeo Wayudi</a></h6>
										</div>
									</div>
								</td>
								<td><span class="text-black fs-16 font-w600">$783.22</span></td>
